...
lyr_WECintegratedBreakwaters_2.set('fieldAliases', {'Year of installation/conception': 'Year of installation/conception', 'Year of decomissioning': 'Year of decomissioning', 'Name': 'Name', 'Technology': 'Technology', 'PTO': 'PTO', 'Country': 'Country', 'City': 'City', 'Type of breakwater': 'Type of breakwater', 'Phase': 'Phase', 'Injecting(/ed) electricity in grid': 'Injecting(/ed) electricity in grid', 'Installed capacity (kW)': 'Installed capacity (kW)', 'Capture width': 'Capture width', 'Comments': 'Comments', 'Relevant papers': 'Relevant papers', 'Latitude': 'Latitude', 'Longitude': 'Longitude', 'Figure': 'Figure', 'field_18': 'field_18', });
lyr_WECintegratedBreakwaters_2.set('fieldImages', {'Year of installation/conception': 'Range', 'Year of decomissioning': 'TextEdit', 'Name': 'TextEdit', 'Technology': 'TextEdit', 'PTO': 'TextEdit', 'Country': 'TextEdit', 'City': 'TextEdit', 'Type of breakwater': 'TextEdit', 'Phase': 'TextEdit', 'Injecting(/ed) electricity in grid': 'TextEdit', 'Installed capacity (kW)': 'TextEdit', 'Capture width': 'TextEdit', 'Comments': 'TextEdit', 'Relevant papers': 'TextEdit', 'Latitude': 'TextEdit', 'Longitude': 'TextEdit', 'Figure': 'TextEdit', 'field_18': 'TextEdit', });
lyr_WECintegratedBreakwaters_2.set('fieldLabels', {'Year of installation/conception': 'header label - always visible', 'Year of decomissioning': 'header label - always visible', 'Name': 'header label - always visible', 'Technology': 'header label - always visible', 'PTO': 'header label - always visible', 'Country': 'header label - always visible', 'City': 'header label - always visible', 'Type of breakwater': 'header label - always visible', 'Phase': 'header label - always visible', 'Injecting(/ed) electricity in grid': 'header label - always visible', 'Installed capacity (kW)': 'header label - always visible', 'Capture width': 'header label - always visible', 'Comments': 'header label - always visible', 'Relevant papers': 'header label - always visible', 'Latitude': 'header label - always visible', 'Longitude': 'header label - always visible', 'Figure': 'header label - always visible', 'field_18': 'header label - always visible', });
