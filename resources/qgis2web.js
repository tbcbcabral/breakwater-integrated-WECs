...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Breakwater-integrated WECs</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (599 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'This map lists all the breakwaters around the world that have Wave Energy Converters integrated into them, as well as providing some details about these. <br /><br />The content on this website is available for use under the condition that proper attribution is given by citing the source as ] and providing the URL.The information provided on this website is for informational purposes only. We make every effort to ensure accuracy, but we do not guarantee the completeness, reliability, or suitability of the content. By using this website, you agree that any reliance on the information is at your own risk';
            }
